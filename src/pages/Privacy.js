...
function Privacy(){
    return (
        <div>
            ...
            ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 비밀번호 질문과 답변 , 이메일 , 서비스 이용기록 , 접속 로그 , 쿠키 , 접속 IP 정보 , 결제기록<br></br>
            ο 개인정보 수집방법 : 홈페이지(회원가입,게시판)<br></br>
            <br></br>
            ■ 개인정보의 수집 및 이용목적<br></br>
            회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다..<br></br>
            ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산<br></br>
            <br></br>
            콘텐츠 제공<br></br>
            ο 회원 관리<br></br>
            <br></br>
            회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인<br></br>
            ...
            <br></br>
            보존 항목 : 로그인ID , 결제기록<br></br>
            보존 근거 : 신용정보의 이용 및 보호에 관한 법률<br></br>
            보존 기간 : 3년<br></br>
            <br></br><br></br>
            표시/광고에 관한 기록 : 6개월 (전자상거래등에서의 소비자보호에 관한 법률)<br></br>
