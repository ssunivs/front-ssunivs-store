            ...
            <ul className={styles.faq}>
                ...
                <li>
                    <details className={styles.faqDetails}>
                        ...
                        <p>펀딩 형태의 결제가 아니기 때문에 일단 수익을 확인해 봐야 알 것 같습니다.<br></br>
                    저도 처음에는 펀딩처럼 진행해 보려 했으나 개인이 플랫폼을 제외 전자상거래업을 통해서 펀딩을 여는 것은 불법이라고 합니다.<br></br>
                    ...
                    또한, 정산이 모든 금액이 되는 것이 아닌 카드수수료를 비롯한 각종 결제수단의 수수료를 제외. PG사의 각종 수수료 제외. 인형처럼 생산-주문-배송이 오래 걸리는 실물 판매의 경우 PG사에서 위험성을 감지. 보증보험 가입을 요구하여 보증보험 가입 된 상태이기 때문에 정산 또한 12~2월에 걸쳐 나누어 받게 됩니다.<br></br>
                    이에 따라 기부도 12월 말 크리스마스 즈음을 예상하나, 원금 회수 가능성에 따라 달라질 수 있다는 점 알려드립니다.<br></br>
                    기부는 숭실대학교 발전기금팀과 협의하여 진행됩니다. </p>
                    </details>
                </li>
            </ul>
